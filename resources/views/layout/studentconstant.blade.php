...
<head>
  ...
  <title>INSTITUTION PROJECT REPOSITORY</title>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">MUST research repository</span>
      </a>
...
<li class="nav-item dropdown pe-3">
    ...
    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        <li class="dropdown-header">
            ...
            <span>{{ Auth::user()->course ?? 'N/A' }}</span> <!-- Display course or N/A if not available -->
        </li>
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
   ...
   <li class="nav-item">
  <a class="nav-link" href="{{ url('studenthomepage') }}">
...
<!-- End Concept Management Nav -->
  @if(Auth::check() && Auth::user()->group)
    <li class="nav-item">
        <a class="nav-link" href="{{ route('concepts.index') }}">
            <i class="bi bi-lightbulb"></i>
            <span>Concept Management</span>
        </a>
    </li>
@endif
<!-- End Group Management Nav -->
<!-- End Concept Management Nav -->
@if(Auth::check() && Auth::user()->group)
    <!-- Proposal Management Nav -->
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('studentprofile.show') }}">
            <i class="bi bi-person"></i>
            <span>My Profile</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ route('studentprofile.settings') }}">
            <i class="bi bi-gear"></i>
            <span>Edit Profile</span>
        </a>
    </li>
@endif
<!-- End Proposal Management Nav -->


  
    <li class="nav-item">
      <a class="nav-link" href=" {{ route('studentgroups.index') }}">
...
<!-- End Proposal Management Nav -->
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="{{ route('studentprofile.show') }}">
        <i class="bi bi-person"></i>
        <span>Profile</span>
    </a>
</li>
